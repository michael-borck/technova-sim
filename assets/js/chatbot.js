(() => {
    ...
    function createElements() {
        ...
        fab.innerHTML = `
            ...
            <span class="fab-label">Ask a staff member</span>
        `;
        fab.title = 'Interview TechNova staff';
        fab.setAttribute('aria-label', 'Open staff chat — interview employees about the incident');
